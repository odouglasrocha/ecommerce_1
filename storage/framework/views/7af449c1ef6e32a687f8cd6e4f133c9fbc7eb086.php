...
<html lang="zxx">
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="<?php echo e(asset('backend/assets/image/icon')); ?>" href="images/favicon-16x16.png"/>
  
  <!-- Main structure css file -->
  <link  rel="stylesheet" href="<?php echo e(asset('backend/assets/css/login5-style.css')); ?>">
 ...
 <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css" >
  ...
  <body>
            ...
            <div class="brand-col">
              <div class="headline">
                ...
                <div class="brand-logo">
                  <img src="<?php echo e(asset('backend/assets/images/brand-logo-white.png')); ?>" width="150" alt="brand-logo">
                </div><!-- ./brand-logo -->
    ...
    <script src="<?php echo e(asset('backend/assets/js/jquery-2.2.4.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\ecommerce\ecommercee\resources\views/auth/admin_login.blade.php ENDPATH**/ ?>