...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<form method="POST" action="<?php echo e(route('register')); ?>">
		...
		<div class="form-group">
	    	...
	    	<input type="text" name="reg_name" id="name" class="form-control unicase-form-control text-input">
...
<?php echo $__env->make('frontend.main_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce\ecommercee\resources\views/auth/login.blade.php ENDPATH**/ ?>