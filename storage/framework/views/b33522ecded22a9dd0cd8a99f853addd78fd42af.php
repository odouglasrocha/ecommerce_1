  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        ...
        <?php $__currentLoopData = $breadsubsubcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li class='active'><?php echo e($item->category->category_name_en); ?></li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

        <?php $__currentLoopData = $breadsubsubcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li class='active'><?php echo e($item->subcategory->subcategory_name_en); ?></li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

         <?php $__currentLoopData = $breadsubsubcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li class='active'><?php echo e($item->subsubcategory_name_en); ?></li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="container">
    <div class="row">
              ...
              <div class="sidebar-widget-body">
                <div class="accordion">
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapse<?php echo e($category->id); ?>" data-toggle="collapse" class="accordion-toggle collapsed"> <?php if(session()->get('language')=='hindi'): ?> <?php echo e($category->category_name_hi); ?> 
                <?php else: ?>
      ...
      <div class="col-md-9"> 
        ...
        <?php $__currentLoopData = $breadsubsubcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <span class="badge badge-danger" style="background: #808080"><?php echo e($item->category->category_name_en); ?> </span>
       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

       <?php $__currentLoopData = $breadsubsubcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <span class="badge badge-danger" style="background: #808080"><?php echo e($item->subcategory->subcategory_name_en); ?> </span>
       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

        <?php $__currentLoopData = $breadsubsubcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <span class="badge badge-danger" style="background: #FF0000"><?php echo e($item->subsubcategory_name_en); ?> </span>
       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.main_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce\ecommercee\resources\views/frontend/product/sub_subcategory_view.blade.php ENDPATH**/ ?>