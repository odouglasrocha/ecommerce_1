...
<img src="<?php echo e(asset('frontend/assets/images/logo.png')); ?>" class="logo" alt="E-COM Logo" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 75px; width: 75px;">
</a>
</td>
</tr>
...
<td> Invoice No : <?php echo e($order['invoice_no']); ?></td> <br>
<td> Amount : ₹<?php echo e($order['amount']); ?></td><br>
<td> Name : <?php echo e($order['name']); ?></td><br>
<td> Email : <?php echo e($order['email']); ?></td><br>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\ecommercee\resources\views/mail/order_mail.blade.php ENDPATH**/ ?>