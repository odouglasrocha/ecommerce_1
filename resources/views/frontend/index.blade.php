            ...
            <div class="item">
                <div class="blog-post">
                  ...
                  <div class="blog-post-info text-left">
                    <h3 class="name"><a href="{{ route('blog.details',$blog->id) }}">@if(session()->get('language') == 'hindi') {{ $blog->post_title_hi }} @else {{ $blog->post_title_en }} @endif</a></h3>
                    <span class="info">{{ Carbon\Carbon::parse($blog->created_at)->diffForHumans()  }}</span>
                    <p class="text">@if(session()->get('language') == 'hindi') {!! Str::limit($blog->post_details_hi, 100 )  !!} @else {!! Str::limit($blog->post_details_en, 100 )  !!} @endif</p>
