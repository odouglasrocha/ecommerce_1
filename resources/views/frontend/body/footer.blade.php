            ...
            <ul class="toggle-footer" style="">
              <li class="media">
                ...
                <div class="media-body">
                  <p>{{$setting->company_name}}, {{$setting->address}}</p>
                </div>
              </li>
              <li class="media">
    ...
    <div class="container">
      <div class="col-xs-12 col-sm-6 no-padding social">
        <ul class="link">
          ...
          <li class="tw pull-left"><a target="_blank" rel="nofollow" href="{{ $setting->twitter }}" title="Twitter"></a></li>          <li class="googleplus pull-left"><a target="_blank" rel="nofollow" href="#" title="GooglePlus"></a></li>
