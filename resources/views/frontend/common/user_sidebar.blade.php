...
<div class="col-md-2">
    <br><br>
                ...
                <a href="{{route('return.orders.list')}}" class="btn btn-primary btn-sm btn-block">Return Orders
                </a>
                <a href="{{route('canceled.orders')}}" class="btn btn-primary btn-sm btn-block">Canceled Orders
                </a>
